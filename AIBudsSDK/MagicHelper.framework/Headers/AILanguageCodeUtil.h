...
/// 返回所有语言数组
/// 每项包含 @{@"code": @(枚举值), @"name": 名称, @"shortCode": 语言code简写, @"locale": BCP-47}
...
/// 多模态支持的所有语言
/// 每项包含 @{@"code": @(枚举值), @"name": 名称, @"shortCode": 语言code简写, @"locale": BCP-47, @"voice": 支持的音色}
+ (NSArray<NSDictionary *> *)multimodalLanguages;

/// 同传v4支持的语种
/// 每项包含 @{@"code": @(枚举值), @"name": 名称, @"shortCode": 语言code简写, @"locale": BCP-47}
+ (NSArray<NSDictionary *> *)simultInterpretationV4Languages;
