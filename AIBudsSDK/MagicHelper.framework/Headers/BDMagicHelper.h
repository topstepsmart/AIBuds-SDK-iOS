...
/// 长语音文件转文本结果回调
- (void)didReceiveIntlLongFileASRResult:(NSDictionary *)result error:(nullable NSError *)error;
...
/// 支持语种：https://docs.qq.com/document/DWWZBY0dObHVNamFI?nlc=1&_bid=1&client=drive_file&tab=v3qifl
- (void)intlLongFileAsr:(ASRLongFileIntlRequestBody *)body;
...
- (void)intlTtsV3:(TTSIntlRequestBody *)body
...
/// qid就是intlTtsV3中body参数的qid
- (void)cancelTTSV3:(NSString *)qid;
