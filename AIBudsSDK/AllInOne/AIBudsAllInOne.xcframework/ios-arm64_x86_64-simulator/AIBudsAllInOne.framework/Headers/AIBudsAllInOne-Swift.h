...
#ifndef AIBUDSALLINONE_SWIFT_H
#define AIBUDSALLINONE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AIBudsAllInOne",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// The main entry point for the AIBudsAllInOneSDK.
/// Use this class to access SDK version information and other global SDK-level functionality.
SWIFT_CLASS("_TtC14AIBudsAllInOne17AIBudsAllInOneSDK")
@interface AIBudsAllInOneSDK : NSObject
/// Private initializer to enforce singleton pattern
/// note:
/// This prevents creating multiple instances of AIBudsAllInOneSDK
...
/// Initializes the entire AIBuds SDK suite via AIBudsAllInOneSDK with default configuration
/// \param delegate The delegate object to receive callbacks from the SDK
///
///
/// returns:
...
///
+ (void)installCrashReporterWithLastCrashReportCallback:(void (^ _Nullable)(NSString * _Nullable))lastCrashReportCallback reportListUpdateCallback:(void (^ _Nullable)(void))reportListUpdateCallback;
...
+ (void)stopAIDashboard;
/// Returns a boolean value indicating whether the AIDashboardSDK is running.
///
/// returns:
/// A boolean value indicating whether the AIDashboardSDK is running
+ (BOOL)isAIDashboardRunning SWIFT_WARN_UNUSED_RESULT;
@end
