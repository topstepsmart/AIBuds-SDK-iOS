...
- (NSArray<DeviceFeatureGroupModel*>*)featureGroups
{
    ...
    return @[
        ...
        [DeviceFeatureGroupModel modelWithIcon:@"icon_live_streaming" name:NSLocalizedString(@"LocKey.LiveStreamingGroupTitle", nil) features:@[
            [DeviceFeatureModel modelWithIcon:@"icon_live_streaming" name:NSLocalizedString(@"LocKey.LiveStreamingFeatureTitle", nil) classNameOfDemoVC:@"LiveStreamingDemoController"],
        ]],
