...
#ifndef AIBUDSLIVESTREAMFLUTTERPLUGIN_SWIFT_H
#define AIBUDSLIVESTREAMFLUTTERPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AIBudsLiveStreamFlutterPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// The main entry point for the AIBudsLiveStreamFlutterPluginSDK.
/// Use this class to access SDK version information and other global SDK-level functionality.
SWIFT_CLASS_NAMED("AIBudsLiveStreamFlutterPluginSDK")
@interface AIBudsLiveStreamFlutterPluginSDK : NSObject <FlutterPlugin>
/// The Flutter method channel used by the Dart-facing plugin project.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull channelName;)
+ (NSString * _Nonnull)channelName SWIFT_WARN_UNUSED_RESULT;
/// The Flutter platform view type used to embed the native live stream player.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull platformViewType;)
+ (NSString * _Nonnull)platformViewType SWIFT_WARN_UNUSED_RESULT;
/// Private initializer to enforce singleton pattern
/// note:
/// This prevents creating multiple instances of AIBudsLiveStreamFlutterPluginSDK
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// Registers the SDK with a Flutter plugin registrar.
/// The final Flutter plugin project should depend on the prebuilt xcframework
/// from this target and call this native registrar from its generated plugin
/// registration path.
+ (void)registerWithRegistrar:(id <FlutterPluginRegistrar> _Nonnull)registrar;
/// Handles method calls from the Dart-facing Flutter plugin layer.
